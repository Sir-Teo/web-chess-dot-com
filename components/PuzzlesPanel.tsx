...
import { Puzzle, Zap, Calendar, Shield, BookOpen } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-[#262522] text-[#c3c3c3]">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#211f1c] border-b border-black/20 shadow-sm">
        <div className="flex items-center gap-2">
          <Puzzle className="w-6 h-6 text-orange-400" fill="currentColor" />
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col gap-6">
        ...
        <div className="flex gap-4 items-start">
            ...
            <div className="bg-white text-[#2b2926] p-3 rounded-xl rounded-tl-none text-[15px] leading-snug shadow-md relative font-medium">
                ...
                Doing Puzzles every day makes it easier to see your opponents mistakes.
            </div>
        </div>
        ...
        <div>
             ...
             <div className="flex justify-end mt-1">
                 <div className="bg-[#3d2918] text-[#c48d5d] px-2 py-0.5 rounded text-xs font-bold flex items-center gap-1">
                    <Puzzle className="w-3 h-3" fill="currentColor" />
                    <span>3</span>
                 </div>
             </div>
        </div>
        ...
        {/* Main Action */}
        <button className="w-full bg-[#81b64c] hover:bg-[#a3d160] text-white font-bold text-2xl py-5 rounded-lg shadow-[0_4px_0_0_#457524] active:shadow-none active:translate-y-[4px] transition-all flex items-center justify-center">
            Solve Puzzles
        </button>
        ...
        <div className="space-y-3">
             ...
             <PuzzleModeButton 
                title="Puzzle Battle" 
                icon={<Shield className="w-6 h-6 text-white" fill="currentColor" />} 
                iconBg="bg-blue-500" 
             />
             <PuzzleModeButton 
                title="Custom Puzzles" 
                icon={<BookOpen className="w-6 h-6 text-[#8b6914]" />} 
                iconBg="bg-[#dcdcdc]" 
             />
        </div>
