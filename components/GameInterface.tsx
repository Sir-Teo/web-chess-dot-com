    ...
    <div className="flex flex-col md:flex-row h-full md:h-screen w-full overflow-hidden bg-chess-dark">
      ...
      <div className="flex-none md:flex-1 flex flex-col items-center justify-start md:justify-center p-0 md:p-4 bg-[#312e2b] relative">
        ...
        <div className="w-full md:max-w-[calc(100vh_-_10rem)] relative flex flex-col justify-center">
            ...
            {/* Player Info (Bottom) */}
            <div className="flex justify-between items-start mt-1 px-3 md:px-1">
                <div className="flex items-center gap-2 md:gap-3">
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded bg-gray-500 overflow-hidden border border-white/20 relative group">
                        <img src="https://picsum.photos/200" alt="Me" className="w-full h-full object-cover" />
                    </div>
      ...
      {/* Right Sidebar */}
      <div className="flex-1 md:flex-none w-full md:w-[320px] lg:w-[350px] xl:w-[420px] bg-[#262522] flex flex-col border-l border-white/10 shrink-0 min-h-0 md:h-full z-10 relative shadow-2xl overflow-hidden">
